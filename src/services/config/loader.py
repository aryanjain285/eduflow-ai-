...
Unified configuration loading for all EduFlow modules.
...
# PROJECT_ROOT points to the actual project root directory (EduFlow/)
# Path(__file__) = src/services/config/loader.py
# .parent = src/services/config/
# .parent.parent = src/services/
# .parent.parent.parent = src/
# .parent.parent.parent.parent = EduFlow/ (project root)
...
def parse_language(language: Any) -> str:
    """
    Unified language configuration parser.

    Currently only English is supported.

    Args:
        language: Language configuration value

    Returns:
        Standardized language code: 'en'
    """
    return "en"
