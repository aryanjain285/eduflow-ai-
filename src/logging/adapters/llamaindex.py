...
Forwards LlamaIndex logs to EduFlow's unified logging system.
"""
...
class LlamaIndexLogForwarder(logging.Handler):
    """
    Handler that forwards LlamaIndex logger messages to EduFlow logger.
    """
    ...
    def emit(self, record: logging.LogRecord):
        """
        Forward log record to EduFlow logger.
        """
        try:
