...
<img src="assets/logo-ver2.png" alt="EduFlow Logo" width="150" style="border-radius: 15px;">

# EduFlow: AI-Powered Personalized Learning Assistant
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <a href="https://github.com/eduflow-ai/EduFlow/issues/78"><img src="https://img.shields.io/badge/WeChat-Join_Group-07C160?style=for-the-badge&logo=wechat&logoColor=white" alt="WeChat"></a>
</p>
...
> **[2026.1.1]** Happy New Year! Join our [Discord Community](https://discord.gg/eRsjPgMU4t), [Wechat Community](https://github.com/eduflow-ai/EduFlow/issues/78), or [Discussions](https://github.com/eduflow-ai/EduFlow/discussions) - shape the future of EduFlow! 💬

> **[2025.12.30]** Visit our [Official Website](https://eduflow.ai/) for more details!

> **[2025.12.29]** EduFlow is now live! ✨

### 📦 Releases

> **[2026.1.23]** Release [v0.6.0](https://github.com/eduflow-ai/EduFlow/releases/tag/v0.6.0) - Frontend session persistence, full Chinese support, Docker deployment updates, and minor bug fixes -- Thanks for all the feedback!

<details>
<summary>History releases</summary>

> **[2026.1.18]** Release [v0.5.2](https://github.com/eduflow-ai/EduFlow/releases/tag/v0.5.1) - Enhance RAG pipeline with Docling support and improve CI/CD workflows with several minor bugs fixed -- Thanks to all the feedbacks!


> **[2026.1.15]** Release [v0.5.0](https://github.com/eduflow-ai/EduFlow/releases/tag/v0.5.0) - Unified LLM & Embedding services, RAG pipeline selection, and major enhancements to Home, History, QuestionGen & Settings modules -- Thanks to all the contributors!

> **[2026.1.9]** Release [v0.4.1](https://github.com/eduflow-ai/EduFlow/releases/tag/v0.4.1) with LLM Provider system overhaul, Question Generation robustness improvements, and codebase cleanup - Thanks to all the contributors!

> **[2026.1.9]** Release [v0.4.0](https://github.com/eduflow-ai/EduFlow/releases/tag/v0.4.0) with new code structure, multiple llm & embeddings support - Thanks to all the contributors!

> **[2026.1.5]** [v0.3.0](https://github.com/eduflow-ai/EduFlow/releases/tag/v0.3.0) - Unified PromptManager architecture, CI/CD automation & pre-built Docker images on GHCR

> **[2026.1.2]** [v0.2.0](https://github.com/eduflow-ai/EduFlow/releases/tag/v0.2.0) - Docker deployment, Next.js 16 & React 19 upgrade, WebSocket security & critical vulnerability fixes
...
<p align="center">
  <sub>🌙 Use EduFlow in <b>Dark Mode</b>!</sub>
</p>

---

## 🏛️ EduFlow's Framework

<div align="center">
<img src="assets/figs/full-pipe.png" alt="EduFlow Full-Stack Workflow" width="100%">
</div>
...
```bash
git clone https://github.com/eduflow-ai/EduFlow.git
cd EduFlow
```
...
- **Research Papers** — 5 papers from our lab ([AI-Researcher](https://github.com/eduflow-ai/AI-Researcher), [LightRAG](https://github.com/eduflow-ai/LightRAG), etc.)
...
docker run -d --name eduflow \
  -p 8001:8001 -p 3782:3782 \
  --env-file .env \
  -v $(pwd)/data:/app/data \
  -v $(pwd)/config:/app/config:ro \
  ghcr.io/eduflow-ai/eduflow:latest
...
conda create -n eduflow python=3.10 && conda activate eduflow
...
Windows has a default limitation on path lengths (260 characters), which can be exceeded by EduFlow's nested directory structures and dependencies.
...
See: [GitHub Issue #112](https://github.com/eduflow-ai/EduFlow/issues/112)
...
<p>
  <a href="https://github.com/eduflow-ai/EduFlow/stargazers"><img src="assets/roster/stargazers.svg" alt="Stargazers"/></a>
  &nbsp;&nbsp;
  <a href="https://github.com/eduflow-ai/EduFlow/network/members"><img src="assets/roster/forkers.svg" alt="Forkers"/></a>
</p>

<a href="https://www.star-history.com/#eduflow-ai/EduFlow&type=timeline&legend=top-left">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=eduflow-ai/EduFlow&type=timeline&theme=dark&legend=top-left" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=eduflow-ai/EduFlow&type=timeline&legend=top-left" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=eduflow-ai/EduFlow&type=timeline&legend=top-left" />
  </picture>
</a>
...
<a href="https://github.com/eduflow-ai/EduFlow/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=eduflow-ai/EduFlow&max=999" alt="Contributors to eduflow-ai/EduFlow" />
</a>
...
| [⚡ LightRAG](https://github.com/eduflow-ai/LightRAG) | [🎨 RAG-Anything](https://github.com/eduflow-ai/RAG-Anything) | [💻 DeepCode](https://github.com/eduflow-ai/DeepCode) | [🔬 AI-Researcher](https://github.com/eduflow-ai/AI-Researcher) |
|:---:|:---:|:---:|:---:|
| Simple and Fast RAG | Multimodal RAG | AI Code Assistant | Research Automation |

**[Data Intelligence Lab @ HKU](https://github.com/eduflow-ai)**

[⭐ Star us](https://github.com/eduflow-ai/EduFlow/stargazers) · [🐛 Report a bug](https://github.com/eduflow-ai/EduFlow/issues) · [💬 Discussions](https://github.com/eduflow-ai/EduFlow/discussions)
...
<p align="center">
  <em> Thanks for visiting ✨ EduFlow!</em><br><br>
  <img src="https://visitor-badge.laobi.icu/badge?page_id=eduflow-ai.EduFlow&style=for-the-badge&color=00d4ff" alt="Views">
</p>
