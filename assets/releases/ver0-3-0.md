# 🚀 EduFlow v0.3.0 Release Notes

**Release Date:** January 6, 2026

We're excited to announce EduFlow v0.3.0! This release focuses on **developer experience improvements**, **CI/CD automation**, and **simplified local deployment**.
...
docker run -d --name eduflow \
  ...
  --env-file .env \
  -v $(pwd)/data:/app/data \
  ghcr.io/eduflow-ai/eduflow:latest### 🏠 Local-First LLM Configuration
...
This aligns with EduFlow's vision for privacy-first, self-hosted AI tutoring.
...
docker pull ghcr.io/eduflow-ai/eduflow:latest*Closes #33*
## What's Changed
* fix(UI): unrendered markdown in ActivityDetail card by @tusharkhatriofficial in https://github.com/eduflow-ai/EduFlow/pull/26
* chore: transtale readme to ru by @oshliaer in https://github.com/eduflow-ai/EduFlow/pull/27
* fix: improve reload_excludes configuration for uvicorn server and added support for newer models (openai) by @LouisACR in https://github.com/eduflow-ai/EduFlow/pull/28
* feat: Dynamic LLM Provider Support (Local & Cloud) by @ahmedjawedaj in https://github.com/eduflow-ai/EduFlow/pull/34

## 🤝New Contributors
* @oshliaer made their first contribution in https://github.com/eduflow-ai/EduFlow/pull/27
* @LouisACR made their first contribution in https://github.com/eduflow-ai/EduFlow/pull/28
* @ahmedjawedaj made their first contribution in https://github.com/eduflow-ai/EduFlow/pull/34
