...
export default function ProgressPanel({
  ...
  return (
    <div className="bg-white dark:bg-[#14142a] p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-white/[0.10]">
      ...
      <div className="h-2 bg-slate-100 dark:bg-white/[0.06] rounded-full overflow-hidden mb-4">
        <div
      ...
      <div className="flex gap-2">
        {canStart && (
          <button
            ...
            disabled={isLoading}
            className="flex-1 px-4 py-2 bg-gradient-to-r from-violet-500 to-blue-600 text-white rounded-lg hover:from-violet-600 hover:to-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm font-medium shadow-md shadow-violet-500/20"
          >
            {isLoading ? (
              <>
