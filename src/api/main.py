...
app = FastAPI(
    ...
    # See: https://github.com/eduflow-ai/EduFlow/issues/112
...
# Physical Path: EduFlow/data/user/solve/solve_xxx/artifacts/image.png
project_root = Path(__file__).parent.parent.parent
...
app.include_router(learning_state.router, prefix="/api/v1/learning-state", tags=["learning-state"])


@app.get("/")
async def root():
    return {"message": "Welcome to EduFlow API"}
