...
export default defineConfig({
  ...
  head: [
    ['link', { rel: 'icon', href: '/EduFlow/logo.png' }]
  ],
    ...
    root: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: 'GitHub', link: 'https://github.com/eduflow-ai/EduFlow' }
        ],
        sidebar: {
          '/guide/': [
            {
        ...
        editLink: {
          pattern: 'https://github.com/eduflow-ai/EduFlow/edit/main/docs/:path',
  ...
  themeConfig: {
    logo: '/logo.png',
    socialLinks: [
      { icon: 'github', link: 'https://github.com/eduflow-ai/EduFlow' },
      { icon: 'discord', link: 'https://discord.gg/eRsjPgMU4t' },
      {
        ...
        link: 'https://github.com/eduflow-ai/EduFlow/issues/78',
        ariaLabel: 'WeChat'
      }
    ],
