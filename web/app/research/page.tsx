  ...
  return (
    <div className="h-screen animate-fade-in flex gap-4 p-4">
      ...
      <div className="flex-[1_1_33%] min-w-[350px] max-w-[500px] flex flex-col gap-4 h-full">
        {/* Config Header */}
        <div className="bg-white dark:bg-white/[0.05] dark:backdrop-blur-xl p-4 rounded-2xl shadow-sm dark:shadow-[0_4px_24px_rgba(0,0,0,0.2)] border border-slate-200 dark:border-white/[0.08] flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-slate-50 dark:bg-white/[0.06] border border-slate-200 dark:border-white/[0.08] rounded-lg text-sm text-slate-900 dark:text-slate-100 outline-none focus:ring-2 focus:ring-emerald-500/20"
              >
                {kbs.length === 0 && (
            ...
            <div>
              ...
              <div className="flex bg-slate-50 dark:bg-white/[0.06] p-1 rounded-lg border border-slate-200 dark:border-white/[0.08]">
                    ...
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-1.5 py-2 px-2 rounded-lg text-xs font-medium transition-all border ${
                        isSelected
                          ...
                          : "bg-slate-50 dark:bg-white/[0.06] text-slate-500 dark:text-slate-400 border-slate-200 dark:border-white/[0.08]"
                      }`}
                    >
            ...
            {/* Optimization Toggle */}
            <div className="flex items-center justify-between bg-slate-50 dark:bg-white/[0.06] px-3 py-2 rounded-lg border border-slate-200 dark:border-white/[0.08]">
        ...
        {/* Chat Interface */}
        <div className="flex-1 bg-white dark:bg-white/[0.05] dark:backdrop-blur-xl rounded-2xl shadow-sm dark:shadow-[0_4px_24px_rgba(0,0,0,0.2)] border border-slate-200 dark:border-white/[0.08] flex flex-col overflow-hidden">
          ...
          >
            {chatHistory.map((msg) => (
              ...
              >
                <div
                  className={`max-w-[90%] rounded-2xl px-4 py-3 text-sm ${msg.role === "user" ? "bg-indigo-100 dark:bg-indigo-900/40 text-indigo-900 dark:text-indigo-100 rounded-tr-none" : "bg-white dark:bg-white/[0.06] border border-slate-200 dark:border-white/[0.08] text-slate-700 dark:text-slate-200 rounded-tl-none shadow-sm"}`}
                >
                  {msg.isOptimizing ? (
                    <div className="flex items-center gap-2">
                  ...
                  state.global.stage === "idle" && (
                    <div className="mt-2 flex gap-2 animate-fade-in">
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-br from-violet-500 to-blue-600 text-white text-xs font-bold rounded-full hover:from-violet-600 hover:to-blue-700 shadow-lg shadow-violet-500/20"
                      >
          ...
          <div className="p-3 bg-white dark:bg-white/[0.05] border-t border-slate-100 dark:border-white/[0.08]">
            <div className="relative flex items-center gap-2">
              ...
              <button
                ...
                className="p-2.5 bg-gradient-to-br from-violet-500 to-blue-600 text-white rounded-xl hover:from-violet-600 hover:to-blue-700 disabled:opacity-50"
              >
                {isOptimizing ? (
      ...
      <div className="flex-[2_1_67%] min-w-0 flex flex-col h-full overflow-hidden bg-white dark:bg-white/[0.05] dark:backdrop-blur-xl rounded-2xl shadow-sm dark:shadow-[0_4px_24px_rgba(0,0,0,0.2)] border border-slate-200 dark:border-white/[0.08] relative">
        <ResearchDashboard
          state={state}
