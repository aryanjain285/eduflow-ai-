...
Migrate existing knowledge bases into EduFlow's knowledge base system.
...
async def migrate_kb(
    ...
    """
    Migrate a knowledge base to EduFlow.
    ...
    print(f"  Knowledge base '{kb_name}' is now available in EduFlow.")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Migrate knowledge bases into EduFlow",
